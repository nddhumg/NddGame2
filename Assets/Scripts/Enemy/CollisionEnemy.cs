...
public class CollisionEnemy : NddBehaviour {
	...
	protected virtual void LoadCapsuleCollider2D(){
		...
		this.capsuleCollider2D.offset = enemyCtrl.EnemySO.sizeCapsule.offsetCollider;
		this.capsuleCollider2D.size = enemyCtrl.EnemySO.sizeCapsule.sizeCollider;
		Debug.LogWarning("Add BoxCollider2D",gameObject);
	}
//
